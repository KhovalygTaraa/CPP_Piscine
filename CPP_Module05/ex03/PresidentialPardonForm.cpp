...
/*   Updated: 2021/04/13 01:05:54 by swquinc          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::string const PresidentialPardonForm::getNamePool(void) const
{
	return("presidential pardon");
}
Form* PresidentialPardonForm::getCopy(std::string const targetName) const
{
	Form *res = new PresidentialPardonForm(targetName);
	return (res);
}
