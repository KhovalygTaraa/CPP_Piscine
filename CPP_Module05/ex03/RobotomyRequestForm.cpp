...
/*   Updated: 2021/04/13 01:05:06 by swquinc          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::string const RobotomyRequestForm::getNamePool(void) const
{
	return("robotomy request");
}
Form* RobotomyRequestForm::getCopy(std::string const targetName) const
{
	Form *res = new RobotomyRequestForm(targetName);
	return (res);
}
