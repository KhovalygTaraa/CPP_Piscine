...
/*   Updated: 2021/04/13 01:04:19 by swquinc          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::string const ShrubberyCreationForm::getNamePool(void) const
{
	return("shrubbery creation");
}
Form* ShrubberyCreationForm::getCopy(std::string const targetName) const
{
	Form *res = new ShrubberyCreationForm(targetName);
	return (res);
}
