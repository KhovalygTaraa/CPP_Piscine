...
/*   Updated: 2021/04/13 01:03:13 by swquinc          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Form 
{
	...
	public:
		...
		virtual std::string const getNamePool(void) const = 0;
		virtual Form* getCopy(std::string const targetName) const = 0;
		...
		class UnsignedException: public std::exception
		{
			private:
				...
				UnsignedException();
			public:
				UnsignedException(std::string name, std::string formName);
