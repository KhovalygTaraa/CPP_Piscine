...
int NinjaTrap::N_get_energy(void)
{
	return(this->energy);
}

int NinjaTrap::N_get_maxenergy(void)
{
	return(this->max_energy);
}

int NinjaTrap::N_get_melee(void)
{
	return(this->melee_dmg);
}
...
{
	if (this->hp > 0)
		std::cout << this->type << " " << this->name << " smashed  " << target << " with hammer and deal " << this->melee_dmg << " points of damage!!!" << std::endl;
}
